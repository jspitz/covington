...
in upright or any other font you prefer (see sec.~\ref{sec:custno}). Also, you can adjust the spacing
...
of example sentences and the separate markup of preamble text in the case if the example sentences are italicized
(see sec.~\ref{sec:custno}).
...
for possibilities to customize the appearance.
...
this uses its own markup as opposed to the markup of the example sentences (sec.~\ref{sec:custno} elaborates how
...
\end{subexamples}
%
Customization possibilities of examples and subexamples are elaborated in the following two sections.

\subsection{Customizing example spacing}\label{sec:custsp}
