...
\begin{description}
	...
	\item[\joption{leftmargin=\{\jparam{length}\}}] Default: \verb|{0pt}|.
	 ...
	 \item[\joption{numberformat=\{\jparam{arabic|roman|Roman|alph|Alph}\}}] Default: \emph{arabic}.
	    The format of the example number.
	 \item[\joption{fnnumberformat=\{\jparam{arabic|roman|Roman|alph|Alph}\}}] Default: \emph{roman}.
	    The format of the example number if \joption{fnexamplecounter=own} or \joption{fnexamplecounter=own-reset}
	    and example is in a footnote.
\end{description}
%
...
\begin{description}
	...
	\item[\joption{numberformat=\{\jparam{arabic|roman|Roman|alph|Alph}\}}] Default: \emph{arabic}.
		The format of the example number.
	\item[\joption{subnumberformat=\{\jparam{arabic|roman|Roman|alph|Alph}\}}] Default: \emph{alph}.
		The format of the sub-example number.
	\item[\joption{fnnumberformat=\{\jparam{arabic|roman|Roman|alph|Alph}\}}] Default: \emph{roman}.
		The format of the example number if \joption{fnexamplecounter=own} or \joption{fnexamplecounter=own-reset}
		and example is in a footnote.
\end{description}
