...
If you need to change the indentation of examples,  you can do so by means of
the length \jcsmacro{exampleind} (which is preset to \texttt{0pt}). Doing \lstinline|\setlength\exampleind{1em}|,
...
\begin{itemize}
	\item New length \jcsmacro{exampleind} to adjust (increase/decrease)
	      the indendation of examples. See sec.~\ref{sec:ex} for details.
\end{itemize}
