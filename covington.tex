...
% Titling
%
\def\pversion{Version 2.10dev}
\def\pdate{May 31, 2023}
...
numerous customizable \LaTeX\ macros aimed at linguistics, including multiple diacritics on the
...
environment as opptional arguments or globally via the \jcsmacro{setexampleoptions} macro (see sec.~\ref{sec:ex}
for details).
