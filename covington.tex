...
Finally, you can customize the markup of the example and sub-example preamble text (supplied either via the \joption{preamble}
...
\begin{itemize}
	\item Add \jcsmacro{expreamble} and \jcsmacro{subexpreamble} macros (sec.~\ref{sec:exs} and \ref{sec:subexs}).
