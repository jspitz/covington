...
% Titling
%
\def\pversion{Version 1.4dev}
\def\pdate{May 21, 2017}
...
The distance between the two diacritics can be adjusted via the length
...
Note that not all accents work in the \jfenv{tabbing} environment.
