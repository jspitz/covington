...
\newcommand*\glosslinetrans[1]{\ifcov@enquote@tl\covenquote{#1}\else#1\fi}
\end{lstlisting}
	     ...
	     for the \joption{enquotetl} option of the gloss macro and is relevant also for low-level commands
	     if you set this option via \jcsmacro{setglossoptions}.
...
\begin{itemize}
	...
	\item New gloss options: \joption{fspreamble}, \joption{fspostamble}, \joption{enquotetl}
	      for full customization of glosses via options (see sec.~\ref{sec:gloss}).
