...
\begin{description}
	\item{\joption{force[=true|false]}:} Force the redefinition of environments that have already been
	defined by other packages or the class (default: \joption{false}).
	...
	\item{\joption{keeplayout[=true|false]}:} Do not tweak the layout (default: \joption{false}).
...
\item{\joption{noglossbreaks[=true|false]}:} If this option is set to \joption{true}, \cvt\ will try hard to prevent
    page breaks within glosses (default: \joption{false}).
...
\item{\joption{owncounter[=true|false]}:} Use an own counter for numbered examples (default: \joption{false}).
...
\item{\joption{fnexamplecounter=main|own|own-reset}:} Specifics of the counter for numbered examples in footnotes
    (default: \joption{main}).
...
\begin{description}
	...
	\item[\joption{fspreamble=\{\jparam{font settings}\}}] Adjusts the font settings of the preamble line.
		 Valid values are \LaTeX\ font switches such as \jfcsmacro{itshape}, \jfcsmacro{bfseries} etc.
	\item[\joption{fspostamble=\{\jparam{font settings}\}}] Adjusts the font settings of the postamble line.
		 Valid values are \LaTeX\ font switches such as \jfcsmacro{itshape}, \jfcsmacro{bfseries} etc.
\end{description}
%
...
The font settings in glosses (for the respective gloss lines as well as the pre- and postamble)
can be adjusted locally via gloss options of globally by way of the global options macro
