...
\begin{itemize}
	\item \jcsmacro{gloss[\jparam{options}]\{\jparam{gloss line 1}\}\{\jparam{gloss line 2}\}\{\jparam{free translation}\}}\\
	       typesets two-line glosses with a translation line
	\item \jcsmacro{glosss[\jparam{options}]\{\jparam{gloss l.\,1}\}\{\jparam{gloss l.\,2}\}\{\jparam{gloss l.\,3}\}\{\jparam{free tr.}\}}\\
...
\begin{description}
	...
	\item[\joption{fi=\{\jparam{font settings}\}}] Adjusts the font settings of the first gloss line.
	        Valid values are \LaTeX\ font switches such as \jfcsmacro{textit}, \jfcsmacro{bfseries} etc.
	\item[\joption{fii=\{\jparam{font settings}\}}] Adjusts the font settings of the second gloss line.
	        Valid values are \LaTeX\ font switches such as \jfcsmacro{textit}, \jfcsmacro{bfseries} etc.
	\item[\joption{fiii=\{\jparam{font settings}\}}] Adjusts the font settings of the third gloss line.
	        Valid values are \LaTeX\ font switches such as \jfcsmacro{textit}, \jfcsmacro{bfseries} etc.
\end{description}
%
If given as the argument to a \jcsmacro{gloss} or \jcsmacro{glosss} macro, the options will only apply to
...
the global options macro \jcsmacro{setglossoptions} and the \joption{fi},
\joption{fii} or \joption{fiii} key, respectively (see sec.~\ref{sec:gmacros}).
...
\glosss[fii={\normalfont\scshape}]
       ...
       {This is another example.}
In order to produce this, we use the \jcsmacro{glosss} macro for a three-line gloss
and pass the \joption{fii} option with the respective font switches in order to
...
\begin{itemize}
	\item Add new gloss macros (\jcsmacro{gloss} and \jcsmacro{glosss})
