...
\begin{description}
	...
	\item[\joption{preamble=\{\jparam{arbitrary text}\}}] Arbitrary text that is inserted on an own line
		...
		set the markup with the \joption{fspreamble} option. Also, judgement markers are properly set
		after the preamble.
...
in our examples in sec.~\ref{sec:exex}).  Also, judgement markers are properly set after the preamble.
...
\joption{postamble} options of this environment).  With all these macros, judgement markers are properly set after
the preamble.
