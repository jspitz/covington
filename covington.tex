...
\end{subexamples}
%
Customization possibilities of examples and subexamples are elaborated in the following three sections.
...
\subsection{Customizing number display}\label{sec:custno}
...
\subsection{Customizing example markup}\label{sec:custexmk}
